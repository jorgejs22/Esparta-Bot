...
&nbsp;
<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="ml-2 inline-block h-4 w-4 text-orange-4" aria-hidden="true"> <polyline points="9 18 15 12 9 6"></polyline> </svg></span></a>   </div> </div> </div>  </div></div> </div> </section> </div></div>  <div class="flex">  <main class="w-full">    <section data-qa="TemplateLayoutTwoColumn" data-experiment-id="first-two-column-element" id="first-two-column-element" class="border-none py-12 bg-white"> <div class="container">  <div>  <div data-qa="FragmentTitleDynamic-ci6nk" data-interval-length="4" class="text-center col-span-4"> <p data-qa="Typography" class="p1"><br>
...
})();</script>  <div class="mt-10 md:mt-12" style="--forcedTabSwitchInterval: 15;"> <div role="tablist" class="flex mb-4 sm:mx-4 md:mx-5 overflow-x-auto" data-qa="TabTitlesContainer-tpxzk"> <div data-qa="TabTitleEntry-tpxzk" class="whitespace-nowrap first:lg:pr-6 first:md:pr-5 first:sm:pr-4 last:lg:pl-6 last:md:pl-5 last:sm:pl-4"> <div role="tab" aria-selected="true" data-qa="tab-title-tpxzk-0" class="active md:min-w-[102px]">  <div data-qa="FragmentTitle" class="text-left col-span-4">  <h4 data-qa="Heading" class="text-[1rem] mr-4 font-normal leading-none cursor-pointer opacity-60 leading-[110%] heading-4">Connect</h4>  </div>  <div class="w-full bg-gray-3 rounded-md" data-qa="tab-progress-container-bar-tpxzk-0"> <div class="w-full bg-gradient-to-mango from-ruby" data-qa="tab-progress-bar-tpxzk-0"></div> </div> </div> </div><div data-qa="TabTitleEntry-tpxzk" class="whitespace-nowrap first:lg:pr-6 first:md:pr-5 first:sm:pr-4 last:lg:pl-6 last:md:pl-5 last:sm:pl-4 lg:px-6 md:px-5 sm:px-4"> <div role="tab" aria-selected="false" data-qa="tab-title-tpxzk-1" class="md:min-w-[102px]">  <div data-qa="FragmentTitle" class="text-left col-span-4">  <h4 data-qa="Heading" class="text-[1rem] mr-4 font-normal leading-none cursor-pointer opacity-60 leading-[110%] heading-4">Protect</h4>  </div>  <div class="w-full bg-gray-3 rounded-md" data-qa="tab-progress-container-bar-tpxzk-1"> <div class="w-full bg-gradient-to-mango from-ruby" data-qa="tab-progress-bar-tpxzk-1"></div> </div> </div> </div><div data-qa="TabTitleEntry-tpxzk" class="whitespace-nowrap first:lg:pr-6 first:md:pr-5 first:sm:pr-4 last:lg:pl-6 last:md:pl-5 last:sm:pl-4"> <div role="tab" aria-selected="false" data-qa="tab-title-tpxzk-2" class="md:min-w-[102px]">  <div data-qa="FragmentTitle" class="text-left col-span-4">  <h4 data-qa="Heading" class="text-[1rem] mr-4 font-normal leading-none cursor-pointer opacity-60 leading-[110%] heading-4">Build</h4>  </div>  <div class="w-full bg-gray-3 rounded-md" data-qa="tab-progress-container-bar-tpxzk-2"> <div class="w-full bg-gradient-to-mango from-ruby" data-qa="tab-progress-bar-tpxzk-2"></div> </div> </div> </div> </div> <div data-qa="contentContainer" class="contentBorder templateLayoutTwoColumn" style="--forcedTabSwitchInterval: 15;"> <div style="--forcedTabSwitchInterval: 15;"> <div role="tabpanel" data-qa="tab-entry-tpxzk-0" class="overflow-hidden pb-6 hidden" aria-hidden="true" data-astro-cid-upvejypx>  <section data-qa="TemplateLayoutTwoColumn" class="py-0"> <div class="container">  <div>  <div class="grid grid-cols-1 md:grid-cols-2 gap-8 md:max-lg:grid-cols-1 md:gap-y-8"> <div data-column="0" class="flex flex-col gap-8 md:col-span-1 justify-center left-col flex flex-col items-start h-full gap-6 md:gap-8">  <div data-qa="FragmentTitle" class="text-left col-span-4">  <h3 data-qa="Heading" class="leading-[110%] heading-3">Connect users and apps securely</h3>  </div>  <div data-qa="FragmentMarkdown"> <div class="space-y-4"><p>SASE keeps hybrid work productive everywhere, securing human and AI agent communications.</p>
