<!DOCTYPE html><html lang="en-us"> <head>
		<script>
			window.redwood={"consentGroups":{"C0001":true,"C0002":true,"C0003":true,"C0004":true},"country":"US","colo":"IAD","user":null,"rv1":"tsk","locale":"en-US"}
    ...
    <script type="text/javascript">
      var OneTrust={"geolocationResponse":{"stateCode":"VA","countryCode":"US"}}
    </script>
    <script>
...
flex-col lg:flex-row w-full md:w-auto
 flex" style="justify-content: center;" data-component-alignment="center"> <picture class="rounded">  <source media="(min-width: 721px)" width="1200" srcset="https://cf-assets.www.cloudflare.com/dzlvafdwdttg/H8YKCRPwuGvDKy1xB8Hnw/7a69c5aa5a264cb5d1a5ad0e94c91719/Threat_1.png"> <img src="https://cf-assets.www.cloudflare.com/dzlvafdwdttg/H8YKCRPwuGvDKy1xB8Hnw/7a69c5aa5a264cb5d1a5ad0e94c91719/Threat_1.png" width="1200" alt="2026 Cloudflare Threat Report" class="w-full h-auto lg:max-w-[160px]"> </picture> </div>   <div class="flex flex-col h-full gap-1" data-astro-cid-7jpwn7vb>  <div data-qa="FragmentTitle" class="md:flex-1 md:w-full text-left col-span-4">  <h6 data-qa="Heading" class="leading-[110%] heading-6">2026 Cloudflare Threat Report</h6> <p data-qa="Typography" class="mt-2 text-base">How adversaries are weaponizing the Internet</p> </div>   <a data-qa="FragmentLink" class="text-base no-underline" href="/lp/threat-report-2026/" target="_self" data-qa-click-title="Homepage - Hero - 2026 Cloudflare Threat Report - link" data-tracking-category="call_to_action" data-tracking-action="hp_banner_cta" data-qa-index="2">Download report<span class="whitespace-nowrap">
&nbsp;
<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="ml-2 inline-block h-4 w-4 text-orange-4" aria-hidden="true"> <polyline points="9 18 15 12 9 6"></polyline> </svg></span></a>   </div> </div> </div>  </div></div> </div> </section> </div></div>  <div class="flex">  <main class="w-full">    <section data-qa="TemplateLayoutTwoColumn" data-experiment-id="first-two-column-element" id="first-two-column-element" class="border-none py-12 bg-white"> <div class="container">  <div>  <div data-qa="FragmentTitleDynamic-elk4l" data-interval-length="4" class="text-center col-span-4"> <p data-qa="Typography" class="p1"><br>
...
})();</script>  <div class="grid grid-cols-1 md:grid-cols-2 gap-4"> <div data-column="0" class="flex flex-col gap-8 md:col-span-1 justify-start">  <div data-qa="FragmentTitle" class="text-left col-span-4">  <h3 data-qa="Heading" class="leading-[110%] heading-3">Connect your workforce, AI agents, apps, and infrastructure</h3>  </div>  <div data-qa="FragmentMarkdown"> <div class="space-y-4"><style>
...
})();</script>  <div class="mt-10 md:mt-12" style="--forcedTabSwitchInterval: 15;"> <div role="tablist" class="flex mb-4 sm:mx-4 md:mx-5 overflow-x-auto" data-qa="TabTitlesContainer-nf8hl"> <div data-qa="TabTitleEntry-nf8hl" class="whitespace-nowrap first:lg:pr-6 first:md:pr-5 first:sm:pr-4 last:lg:pl-6 last:md:pl-5 last:sm:pl-4"> <div role="tab" aria-selected="true" data-qa="tab-title-nf8hl-0" class="active md:min-w-[102px]">  <div data-qa="FragmentTitle" class="text-left col-span-4">  <h4 data-qa="Heading" class="text-[1rem] mr-4 font-normal leading-none cursor-pointer opacity-60 leading-[110%] heading-4">Connect</h4>  </div>  <div class="w-full bg-gray-3 rounded-md" data-qa="tab-progress-container-bar-nf8hl-0"> <div class="w-full bg-gradient-to-mango from-ruby" data-qa="tab-progress-bar-nf8hl-0"></div> </div> </div> </div><div data-qa="TabTitleEntry-nf8hl" class="whitespace-nowrap first:lg:pr-6 first:md:pr-5 first:sm:pr-4 last:lg:pl-6 last:md:pl-5 last:sm:pl-4 lg:px-6 md:px-5 sm:px-4"> <div role="tab" aria-selected="false" data-qa="tab-title-nf8hl-1" class="md:min-w-[102px]">  <div data-qa="FragmentTitle" class="text-left col-span-4">  <h4 data-qa="Heading" class="text-[1rem] mr-4 font-normal leading-none cursor-pointer opacity-60 leading-[110%] heading-4">Protect</h4>  </div>  <div class="w-full bg-gray-3 rounded-md" data-qa="tab-progress-container-bar-nf8hl-1"> <div class="w-full bg-gradient-to-mango from-ruby" data-qa="tab-progress-bar-nf8hl-1"></div> </div> </div> </div><div data-qa="TabTitleEntry-nf8hl" class="whitespace-nowrap first:lg:pr-6 first:md:pr-5 first:sm:pr-4 last:lg:pl-6 last:md:pl-5 last:sm:pl-4"> <div role="tab" aria-selected="false" data-qa="tab-title-nf8hl-2" class="md:min-w-[102px]">  <div data-qa="FragmentTitle" class="text-left col-span-4">  <h4 data-qa="Heading" class="text-[1rem] mr-4 font-normal leading-none cursor-pointer opacity-60 leading-[110%] heading-4">Build</h4>  </div>  <div class="w-full bg-gray-3 rounded-md" data-qa="tab-progress-container-bar-nf8hl-2"> <div class="w-full bg-gradient-to-mango from-ruby" data-qa="tab-progress-bar-nf8hl-2"></div> </div> </div> </div> </div> <div data-qa="contentContainer" class="contentBorder templateLayoutTwoColumn" style="--forcedTabSwitchInterval: 15;"> <div style="--forcedTabSwitchInterval: 15;"> <div role="tabpanel" data-qa="tab-entry-nf8hl-0" class="overflow-hidden pb-6 hidden" aria-hidden="true" data-astro-cid-upvejypx>  <section data-qa="TemplateLayoutTwoColumn" class="py-0"> <div class="container">  <div>  <div class="grid grid-cols-1 md:grid-cols-2 gap-8 md:max-lg:grid-cols-1 md:gap-y-8"> <div data-column="0" class="flex flex-col gap-8 md:col-span-1 justify-center left-col flex flex-col items-start h-full gap-6 md:gap-8">  <div data-qa="FragmentTitle" class="text-left col-span-4">  <h3 data-qa="Heading" class="leading-[110%] heading-3">Connect users and apps securely</h3>  </div>  <div data-qa="FragmentMarkdown"> <div class="space-y-4"><p>SASE keeps hybrid work productive everywhere, securing human and AI agent communications.</p>
...
</div> </div>  </div></div></div> </div><div class> <div data-qa="FadeInOutCard"><div class="relative h-full fade-card gap-4 md:gap-6 bg-white text-center border border-gray-200 border-solid rounded-lg shadow"><div class="fade-card-front p-3 gap-y-2 md:p-6"> <div data-qa="FragmentAssetImageContentful" class="flex" style="justify-content: center;" data-component-alignment="center"> <picture>  <source media="(min-width: 721px)" width="44" srcset="https://cf-assets.www.cloudflare.com/dzlvafdwdttg/1bFuuCltYhpEJ6GXurbDkM/d35e3a7906ad77973f8dc15f98783e0e/Type_solid__1__1.svg"> <img src="https://cf-assets.www.cloudflare.com/dzlvafdwdttg/1bFuuCltYhpEJ6GXurbDkM/d35e3a7906ad77973f8dc15f98783e0e/Type_solid__1__1.svg" width="44" alt="innovation-intelligence"> </picture> </div>   <div data-qa="FragmentTitle" class="text-center col-span-4">  <h6 data-qa="Heading" class="leading-[110%] heading-6">Secure generative and agentic AI</h6>  </div> </div><div class="fade-card-back p-3 md:p-6"> <a data-qa="FragmentLink" class="text-base no-underline" href="/ai-security/" target="_self" data-qa-click-title="Homepage - Solutions - Card Grid - Card Container - Card - BSecure generative and agentic AI - button" data-tracking-category="call_to_action" data-tracking-action="hp_blade_cta" data-qa-index="2">Secure generative and agentic AI<span class="whitespace-nowrap">
&nbsp;
...
&nbsp;
<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="ml-2 inline-block h-4 w-4 text-orange-4" aria-hidden="true"> <polyline points="9 18 15 12 9 6"></polyline> </svg></span></a>  </div>  </div><div class="snap-start" role="group" aria-roledescription="slide" aria-label="Card 4 of 4" tabindex="0" style="flex: 0 0 100%; @media screen(md){flex: 0 0 50%;} @media screen(lg){flex: 0 0 33.333333%;}" data-astro-cid-cnpfhmvd>  <div data-qa="BlockCard" class="h-full flex flex-col gap-4 md:gap-6 resource-card relative bg-white border border-gray-200 border-solid rounded-xl shadow text-left pt-0 pb-5 px-0 justify-start"> <div data-qa="FragmentAssetImageContentful" class="flex" style="justify-content: left;" data-component-alignment="center"> <picture>  <source media="(min-width: 721px)" width="592" srcset="https://cf-assets.www.cloudflare.com/dzlvafdwdttg/6MWjkO0im0GzSAgiGazIm3/09bc62dfa60dbef02287ed5e4b07f44e/Ebook-Thumbnail-3.png"> <img src="https://cf-assets.www.cloudflare.com/dzlvafdwdttg/6MWjkO0im0GzSAgiGazIm3/09bc62dfa60dbef02287ed5e4b07f44e/Ebook-Thumbnail-3.png" width="592" alt="Background image"> </picture> </div>   <div data-qa="FragmentTitle" class="text-left col-span-4"> <p data-qa="Typography" class="mb-3.5 text-gray-4 text-sm uppercase font-semibold">eBook</p> <h6 data-qa="Heading" class="leading-[110%] heading-6">Increase developer velocity with a connectivity cloud</h6>  </div>  <a data-qa="FragmentLink" class="text-base no-underline" href="/lp/increase-developer-velocity-with-a-connectivity-cloud/" target="_self" data-qa-click-title="Resource Card - eBook - Increase developer velocity with a connectivity cloud - Link" data-tracking-category="call_to_action" data-tracking-action="hp_blade_cta" data-qa-index="4">Read<span class="whitespace-nowrap">
&nbsp;
<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="ml-2 inline-block h-4 w-4 text-orange-4" aria-hidden="true"> <polyline points="9 18 15 12 9 6"></polyline> </svg></span></a>  </div>  </div> </div> <div class="carousel-nav flex gap-4" role="group" aria-label="Carousel navigation" data-astro-cid-cnpfhmvd> <button class="carousel-nav-button prev" aria-label="Previous page" data-astro-cid-cnpfhmvd> <svg width="28" height="29" viewBox="0 0 28 29" fill="none" class="text-ruby" xmlns="http://www.w3.org/2000/svg"> <rect x="0.19043" y="0.5" width="27.8095" height="27.8095" rx="13.9048" fill="currentColor"></rect> <path d="M11.6643 14.0945L11.347 14.405L11.6643 14.7156L17.7904 20.7111C17.7905 20.7113 17.7906 20.7114 17.7908 20.7115C18.0626 20.979 18.0782 21.4344 17.8226 21.7213L17.822 21.722C17.6932 21.8672 17.5235 21.9366 17.3541 21.9366C17.1997 21.9366 17.043 21.8784 16.9158 21.7542L10.7236 15.6939C10.7235 15.6938 10.7233 15.6937 10.7232 15.6936C10.3757 15.3523 10.1845 14.8975 10.1845 14.4051C10.1845 13.9125 10.3757 13.4579 10.7242 13.1167C10.7242 13.1167 10.7242 13.1167 10.7242 13.1166L16.9172 7.05571L16.9177 7.05513C17.1763 6.80107 17.5792 6.8136 17.8233 7.08839L17.8237 7.08882C18.0796 7.37609 18.0633 7.83248 17.792 8.09847C17.792 8.09851 17.7919 8.09855 17.7919 8.09859L11.6643 14.0945Z" fill="white" stroke="white" stroke-width="0.869048"></path> </svg> </button> <button class="carousel-nav-button next" aria-label="Next page" data-astro-cid-cnpfhmvd> <svg width="28" height="29" viewBox="0 0 28 29" fill="none" class="text-ruby" xmlns="http://www.w3.org/2000/svg"> <rect y="0.5" width="27.8095" height="27.8095" rx="13.9048" fill="currentColor"></rect> <path d="M10.1774 7.08838L10.1778 7.08795C10.4212 6.81397 10.8235 6.80074 11.0841 7.05537C11.0841 7.05541 11.0841 7.05544 11.0842 7.05547L17.2765 13.116C17.2765 13.116 17.2766 13.1161 17.2766 13.1161C17.6242 13.4574 17.8155 13.9123 17.8155 14.4048C17.8155 14.8974 17.6243 15.3521 17.2768 15.6934C17.2767 15.6935 17.2766 15.6936 17.2765 15.6937L11.0842 21.7541C11.0842 21.7542 11.0841 21.7543 11.084 21.7544C10.9568 21.8785 10.8003 21.9366 10.646 21.9366C10.4768 21.9366 10.3066 21.8674 10.1763 21.7213C9.92048 21.4341 9.93675 20.9777 10.2079 20.7117C10.208 20.7116 10.2081 20.7116 10.2082 20.7115L16.3357 14.7154L16.6531 14.4048L16.3357 14.0943L10.2082 8.0982C10.2081 8.09816 10.2081 8.09812 10.208 8.09809C9.93729 7.8326 9.92103 7.37623 10.1774 7.08838Z" fill="white" stroke="white" stroke-width="0.869048"></path> </svg> </button> </div>   </div>  </div> <div role="tabpanel" data-qa="tab-entry-h8t7q-3" class="overflow-hidden pb-6 hidden" aria-hidden="true" data-astro-cid-upvejypx>  <div data-qa="BlockCardContainerCarousel" role="region" aria-roledescription="carousel" class="relative flex flex-col items-center overflow-hidden gap-8" data-astro-cid-cnpfhmvd> <div class="carousel-live-region" aria-live="polite" aria-atomic="true" data-astro-cid-cnpfhmvd></div> <div data-qa="BlockCardContainer" role="group" aria-label="Card container" class="grid grid-cols-1 gap-8 pb-2.5" data-astro-cid-cnpfhmvd> <div class="snap-start" role="group" aria-roledescription="slide" aria-label="Card 1 of 7" tabindex="0" style="flex: 0 0 100%; @media screen(md){flex: 0 0 50%;} @media screen(lg){flex: 0 0 33.333333%;}" data-astro-cid-cnpfhmvd>  <div data-qa="BlockCard" class="h-full flex flex-col gap-4 md:gap-6 resource-card relative bg-white border border-gray-200 border-solid rounded-xl shadow text-left pt-0 pb-5 px-0 justify-start"> <div data-qa="FragmentAssetImageContentful" class="flex" style="justify-content: left;" data-component-alignment="center"> <picture>  <source media="(min-width: 721px)" width="592" srcset="https://cf-assets.www.cloudflare.com/dzlvafdwdttg/2SCc1vClEOG4egxglJL22X/b958f7530725c10833affa2b0f04dc4b/Event-Thumbnail-2.png"> <img src="https://cf-assets.www.cloudflare.com/dzlvafdwdttg/2SCc1vClEOG4egxglJL22X/b958f7530725c10833affa2b0f04dc4b/Event-Thumbnail-2.png" width="592" alt="Connect 2026"> </picture> </div>   <div data-qa="FragmentTitle" class="text-left col-span-4"> <p data-qa="Typography" class="mb-3.5 text-gray-4 text-sm uppercase font-semibold">Event</p> <h6 data-qa="Heading" class="leading-[110%] heading-6">Registration is now open for Cloudflare Connect 2026</h6>  </div>  <a data-qa="FragmentLink" class="text-base no-underline" href="/lp/cloudflare-connect-2026/" target="_self" data-qa-click-title="Resource Card - Event - Connect London 2025 - Link" data-tracking-category="call_to_action" data-tracking-action="hp_blade_cta" data-qa-index="1">Learn more<span class="whitespace-nowrap">
&nbsp;
<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="ml-2 inline-block h-4 w-4 text-orange-4" aria-hidden="true"> <polyline points="9 18 15 12 9 6"></polyline> </svg></span></a>  </div>  </div><div class="snap-start" role="group" aria-roledescription="slide" aria-label="Card 2 of 7" tabindex="0" style="flex: 0 0 100%; @media screen(md){flex: 0 0 50%;} @media screen(lg){flex: 0 0 33.333333%;}" data-astro-cid-cnpfhmvd>  <div data-qa="BlockCard" class="h-full flex flex-col gap-4 md:gap-6 resource-card relative bg-white border border-gray-200 border-solid rounded-xl shadow text-left pt-0 pb-5 px-0 justify-start"> <div data-qa="FragmentAssetImageContentful" class="flex" style="justify-content: left;" data-component-alignment="center"> <picture>  <source media="(min-width: 721px)" width="592" srcset="https://cf-assets.www.cloudflare.com/dzlvafdwdttg/173a1i2FtYEjluy1e9nqPz/d1b53b5c7e583b64ac5e7f87e4912a60/Video-Thumbnail-2.png"> <img src="https://cf-assets.www.cloudflare.com/dzlvafdwdttg/173a1i2FtYEjluy1e9nqPz/d1b53b5c7e583b64ac5e7f87e4912a60/Video-Thumbnail-2.png" width="592" alt="App services demo"> </picture> </div>   <div data-qa="FragmentTitle" class="text-left col-span-4"> <p data-qa="Typography" class="mb-3.5 text-gray-4 text-sm uppercase font-semibold">Webinar</p> <h6 data-qa="Heading" class="leading-[110%] heading-6">Join our solutions engineering team for a weekly application services demo</h6>  </div>  <a data-qa="FragmentLink" class="text-base no-underline" href="/product-demos/" target="_self" data-qa-click-title="Resource Card - Webinar - Application services demo series  - Link" data-tracking-category="call_to_action" data-tracking-action="hp_blade_cta" data-qa-index="2">Register<span class="whitespace-nowrap">
&nbsp;
<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="ml-2 inline-block h-4 w-4 text-orange-4" aria-hidden="true"> <polyline points="9 18 15 12 9 6"></polyline> </svg></span></a>  </div>  </div><div class="snap-start" role="group" aria-roledescription="slide" aria-label="Card 3 of 7" tabindex="0" style="flex: 0 0 100%; @media screen(md){flex: 0 0 50%;} @media screen(lg){flex: 0 0 33.333333%;}" data-astro-cid-cnpfhmvd>  <div data-qa="BlockCard" class="h-full flex flex-col gap-4 md:gap-6 resource-card relative bg-white border border-gray-200 border-solid rounded-xl shadow text-left pt-0 pb-5 px-0 justify-start"> <div data-qa="FragmentAssetImageContentful" class="flex" style="justify-content: left;" data-component-alignment="center"> <picture>  <source media="(min-width: 721px)" width="1184" srcset="https://cf-assets.www.cloudflare.com/dzlvafdwdttg/02QH4tKACCGsmFHGHezPg/ec80e33f227c7a74223e58a0eb473036/Event-Thumbnail-1.png"> <img src="https://cf-assets.www.cloudflare.com/dzlvafdwdttg/02QH4tKACCGsmFHGHezPg/ec80e33f227c7a74223e58a0eb473036/Event-Thumbnail-1.png" width="1184" alt="Cloudflare events"> </picture> </div>   <div data-qa="FragmentTitle" class="text-left col-span-4"> <p data-qa="Typography" class="mb-3.5 text-gray-4 text-sm uppercase font-semibold">Event</p> <h6 data-qa="Heading" class="leading-[110%] heading-6">Learn more about Cloudflare and meet our team at an upcoming event near you</h6>  </div>  <a data-qa="FragmentLink" class="text-base no-underline" href="/events/" target="_self" data-qa-click-title="Resource Card - Webinar - New Events Page - Link" data-tracking-category="call_to_action" data-tracking-action="hp_blade_cta" data-qa-index="3">Register<span class="whitespace-nowrap">
&nbsp;
